...
to start coding: A directory structure, some classes and unit tests to get started, and a build script.}
  ...
  s.extra_rdoc_files = ["History.txt", "Manifest.txt", "PostInstall.txt", "app_generators/ruby/templates/file.txt"]
  s.files = ["History.txt", "MIT-LICENSE", "Manifest.txt", "PostInstall.txt", "README.rdoc", "Rakefile", "app_generators/java/USAGE", "app_generators/java/java_generator.rb", "app_generators/java/templates/Greeting.java", "app_generators/java/templates/GreetingTest.java", "app_generators/java/templates/build.xml", "app_generators/java/templates/lib/hamcrest-core.jar", "app_generators/java/templates/lib/junit.jar", "app_generators/java/templates/project.iml", "app_generators/java/templates/project.ipr", "app_generators/ruby/USAGE", "app_generators/ruby/ruby_generator.rb", "app_generators/ruby/templates/file.txt", "app_generators/ruby/templates/rakefile.rb", "app_generators/ruby/templates/right_triangle.rb", "app_generators/ruby/templates/shubox.rb", "app_generators/ruby/templates/test_helper.rb", "app_generators/ruby/templates/test_io.rb", "app_generators/ruby/templates/test_right_triangle.rb", "bin/shubox", "cleaner_generators/install_test_unit_cleaner/install_test_unit_cleaner_generator.rb", "cleaner_generators/install_test_unit_cleaner/templates/clean_test_unit", "cleaner_generators/install_test_unit_cleaner/templates/test_unit_cleaner.rb", "lib/languages.rb", "lib/shubox.rb", "lib/shubox_app_generator.rb", "script/console", "script/destroy", "script/generate", "test/test_generator_helper.rb", "test/test_helper.rb", "test/test_java_generator.rb", "test/test_languages.rb", "test/test_ruby_generator.rb", "test/test_test_unit_cleaner.rb", "test/tmp/myproject/script/test_unit_cleaner.rb", "test/tmp/myproject/test/samples/test_right_triangle.rb", "test/tmp/myproject/test/test_helper.rb", "test/tmp/myproject/test/test_io.rb"]
  ...
  s.test_files = ["test/test_generator_helper.rb", "test/test_helper.rb", "test/test_java_generator.rb", "test/test_languages.rb", "test/test_ruby_generator.rb", "test/test_test_unit_cleaner.rb", "test/tmp/myproject/script/test_unit_cleaner.rb", "test/tmp/myproject/test/samples/test_right_triangle.rb", "test/tmp/myproject/test/test_helper.rb", "test/tmp/myproject/test/test_io.rb"]
